    ...
    return (
        <div className="mx-auto container px-6 xl:px-0 py-12">
            <div className="flex flex-col">
                ...
                <div className="mt-10 grid lg:grid-cols-1 gap-x-8 gap-y-8 items-center">
                    {
                        isLoading ? (
                            <Loader />
                          ) : (
                            ...
                            <div className="absolute sm:top-8 top-4 left-4 sm:left-8 flex justify-start items-start flex-col space-y-2">
                                <div>
                                    <p className="group-hover:opacity-60 transition duration-500 text-xl leading-5 text-gray-600">{curr.name}</p>
                                </div>
                                <div>
                                    <p className="group-hover:opacity-60 transition duration-500 text-xl font-semibold leading-5 text-gray-800">{priceFormat(curr.price)}</p>
                                </div>
                            </div>
